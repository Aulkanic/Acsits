...
try {
  ...
  return (
    <div className='flex gap-4 p-8 flex-nowrap'>
      <div className='flex flex-col gap-8'>
        <div className='relative'>
          ...
          {loading ? (
            <Skeleton active paragraph={{ rows: 5 }} className="px-16 py-12 w-[600px] h-[285px] bg-white rounded-xl shadow-[0px_8px_5px_0px_#a0aec0]" />
          ) : (
            <Swiper
              spaceBetween={30}
              effect={'fade'}
                  ...
                  <SwiperSlide key={idx} className='px-16 py-8 bg-cover'>
                    <div className='bg-white rounded-xl'>
                      <div className='relative'>
                        ...
                        <img className='w-full h-[275px]' src={h.image || ''} alt="" />
                      </div>
      ...
      <div className='relative flex-1'>
        <p className='absolute -top-4 left-1/2 transform -translate-x-1/2 z-50 w-[162px] h-[38px] text-[20px] font-[500] bg-[#060E61] text-white flex justify-center items-center p-4 rounded-full'>PLANS</p>
        {loading ? (
          <Skeleton active paragraph={{ rows: 16 }} className="px-16 py-12 w-full h-full pt-8 pb-4 flex flex-col gap-8 bg-white shadow-[0px_8px_5px_0px_#a0aec0] rounded-xl" />
        ) : (
          <div className='w-full h-full pt-8 pb-4 overflow-y-auto flex flex-col gap-8 bg-white shadow-[0px_8px_5px_0px_#a0aec0] rounded-xl'>
      ...
      <div className='flex flex-col gap-8 flex-wrap'>
        <div className='relative'>
          ...
          {loading ? (
            <Skeleton active paragraph={{ rows: 4 }} className="px-16 py-12 w-[268px] h-[256px] pt-8 pb-4 flex flex-col gap-8 bg-white shadow-[0px_8px_5px_0px_#a0aec0] rounded-xl" />
          ) : (
        ...
        <div className='relative flex-1'>
          ...
          {loading ? (
            <Skeleton active paragraph={{ rows: 6 }} className="px-16 py-12 w-[268px] h-full pt-8 pb-4 flex flex-col gap-8 bg-white shadow-[0px_8px_5px_0px_#a0aec0] rounded-xl" />
          ) : (
